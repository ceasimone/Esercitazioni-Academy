...
//		model.addAttribute("cliente", "Il cliente  "+ nomeCliente + " rappresenta " + prodotto);
//		return "index";
//	}
...
//	}
	...
	@RequestMapping("{nomeCliente}/Carrello")
	public String getCliente1(@PathVariable String nomeCliente,  @RequestParam String prodotto, Model model) {
